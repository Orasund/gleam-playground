...
pub fn ambient_light__v1_v2_v3_alpha(
  v1: Float,
  v2: Float,
  v3: Float,
  alpha: Float,
...
pub fn array_copy__src_dst_length(
  src: Array(any),
  dst: Array(any),
  length: Int,
) -> Nil
...
pub fn array_copy__src_src_position_dst_dst_position_length(
  src: Array(any),
  src_position: Int,
  dst: Array(any),
  dst_position: Int,
...
pub fn bezier__x1_y1_x2_y2_x3_y3_x4_y4(
  x1: Float,
  y1: Float,
  x2: Float,
  y2: Float,
...
pub fn bezier__x1_y1_z1_x2_y2_z2_x3_y3_z3_x4_y4_z4(
  x1: Float,
  y1: Float,
  z1: Float,
  x2: Float,
...
pub fn bezier_point__a_b_c_d_t(
  a: Float,
  b: Float,
  c: Float,
  d: Float,
...
pub fn bezier_tangent__a_b_c_d_t(
  a: Float,
  b: Float,
  c: Float,
  d: Float,
...
pub fn blend__src_image_sx_sy_sw_sh_dx_dy_dw_dh_blend_mode(
  src_image: P5Image,
  sx: Int,
  sy: Int,
  sw: Int,
...
pub fn blend__sx_sy_sw_sh_dx_dy_dw_dh_blend_mode(
  sx: Int,
  sy: Int,
  sw: Int,
  sh: Int,
...
pub fn box__width_height_depth_detail_x(
  width: Float,
  height: Float,
  depth: Float,
  detail_x: Int,
...
pub fn box__width_height_depth_detail_x_detail_y(
  width: Float,
  height: Float,
  depth: Float,
  detail_x: Int,
...
pub fn camera__x_y_z_center_x_center_y(
  x: Float,
  y: Float,
  z: Float,
  center_x: Float,
...
pub fn camera__x_y_z_center_x_center_y_center_z(
  x: Float,
  y: Float,
  z: Float,
  center_x: Float,
...
pub fn camera__x_y_z_center_x_center_y_center_z_up_x(
  x: Float,
  y: Float,
  z: Float,
  center_x: Float,
...
pub fn camera__x_y_z_center_x_center_y_center_z_up_x_up_y(
  x: Float,
  y: Float,
  z: Float,
  center_x: Float,
...
pub fn camera__x_y_z_center_x_center_y_center_z_up_x_up_y_up_z(
  x: Float,
  y: Float,
  z: Float,
  center_x: Float,
...
pub fn cone__radius_height_detail_x(
  radius: Float,
  height: Float,
  detail_x: Int,
) -> Nil
...
pub fn cone__radius_height_detail_x_detail_y(
  radius: Float,
  height: Float,
  detail_x: Int,
  detail_y: Int,
...
pub fn cone__radius_height_detail_x_detail_y_cap(
  radius: Float,
  height: Float,
  detail_x: Int,
  detail_y: Int,
...
pub fn create_a__href_html_target(
  href: String,
  html: String,
  target: String,
) -> P5Element
...
pub fn create_convolver__path_callback(
  path: String,
  callback: fn() -> Nil,
) -> P5Convolver

@external(javascript, "../p5.mjs", "create_convolver__path_callback_error_callback")
pub fn create_convolver__path_callback_error_callback(
  path: String,
  callback: fn() -> Nil,
  error_callback: fn() -> Nil,
) -> P5Convolver
...
pub fn create_shader__vert_src_frag_src(
  vert_src: String,
  frag_src: String,
) -> P5Shader
...
pub fn create_slider__min_max_value(
  min: Float,
  max: Float,
  value: Float,
) -> P5Element
...
pub fn create_slider__min_max_value_step(
  min: Float,
  max: Float,
  value: Float,
  step: Float,
...
pub fn create_writer__name_extension(
  name: String,
  extension: String,
) -> P5PrintWriter
...
pub fn curve__x1_y1_x2_y2_x3_y3_x4_y4(
  x1: Float,
  y1: Float,
  x2: Float,
  y2: Float,
...
pub fn curve__x1_y1_z1_x2_y2_z2_x3_y3_z3_x4_y4_z4(
  x1: Float,
  y1: Float,
  z1: Float,
  x2: Float,
...
pub fn curve_tangent__a_b_c_d_t(
  a: Float,
  b: Float,
  c: Float,
  d: Float,
...
pub fn cylinder__radius_height_detail_x(
  radius: Float,
  height: Float,
  detail_x: Int,
) -> Nil
...
pub fn cylinder__radius_height_detail_x_detail_y(
  radius: Float,
  height: Float,
  detail_x: Int,
  detail_y: Int,
...
pub fn cylinder__radius_height_detail_x_detail_y_bottom_cap(
  radius: Float,
  height: Float,
  detail_x: Int,
  detail_y: Int,
...
pub fn cylinder__radius_height_detail_x_detail_y_bottom_cap_top_cap(
  radius: Float,
  height: Float,
  detail_x: Int,
  detail_y: Int,
...
pub fn debug_mode__grid_size_grid_divisions(
  grid_size: Float,
  grid_divisions: Float,
) -> Nil

@external(javascript, "../p5.mjs", "debug_mode__grid_size_grid_divisions_grid_xoff")
pub fn debug_mode__grid_size_grid_divisions_grid_xoff(
  grid_size: Float,
  grid_divisions: Float,
  grid_xoff: Float,
) -> Nil
...
pub fn debug_mode__grid_size_grid_divisions_grid_xoff_grid_yoff(
  grid_size: Float,
  grid_divisions: Float,
  grid_xoff: Float,
  grid_yoff: Float,
...
pub fn debug_mode__grid_size_grid_divisions_grid_xoff_grid_yoff_grid_zoff(
  grid_size: Float,
  grid_divisions: Float,
  grid_xoff: Float,
  grid_yoff: Float,
...
pub fn debug_mode__grid_size_grid_divisions_grid_xoff_grid_yoff_grid_zoff_axes_size(
  grid_size: Float,
  grid_divisions: Float,
  grid_xoff: Float,
  grid_yoff: Float,
...
pub fn debug_mode__grid_size_grid_divisions_grid_xoff_grid_yoff_grid_zoff_axes_size_axes_xoff(
  grid_size: Float,
  grid_divisions: Float,
  grid_xoff: Float,
  grid_yoff: Float,
...
pub fn debug_mode__grid_size_grid_divisions_grid_xoff_grid_yoff_grid_zoff_axes_size_axes_xoff_axes_yoff(
  grid_size: Float,
  grid_divisions: Float,
  grid_xoff: Float,
  grid_yoff: Float,
...
pub fn debug_mode__grid_size_grid_divisions_grid_xoff_grid_yoff_grid_zoff_axes_size_axes_xoff_axes_yoff_axes_zoff(
  grid_size: Float,
  grid_divisions: Float,
  grid_xoff: Float,
  grid_yoff: Float,
...
pub fn debug_mode__mode_axes_size_x_off(
  mode: String,
  axes_size: Float,
  x_off: Float,
) -> Nil
...
pub fn debug_mode__mode_axes_size_x_off_y_off(
  mode: String,
  axes_size: Float,
  x_off: Float,
  y_off: Float,
...
pub fn debug_mode__mode_axes_size_x_off_y_off_z_off(
  mode: String,
  axes_size: Float,
  x_off: Float,
  y_off: Float,
...
pub fn debug_mode__mode_grid_size_grid_divisions(
  mode: String,
  grid_size: Float,
  grid_divisions: Float,
) -> Nil
...
pub fn debug_mode__mode_grid_size_grid_divisions_x_off(
  mode: String,
  grid_size: Float,
  grid_divisions: Float,
  x_off: Float,
...
pub fn debug_mode__mode_grid_size_grid_divisions_x_off_y_off(
  mode: String,
  grid_size: Float,
  grid_divisions: Float,
  x_off: Float,
...
pub fn debug_mode__mode_grid_size_grid_divisions_x_off_y_off_z_off(
  mode: String,
  grid_size: Float,
  grid_divisions: Float,
  x_off: Float,
...
pub fn describe_element__name_text_display(
  name: String,
  text: String,
  display: String,
) -> Nil
...
pub fn directional_light__color_direction(
  color: String,
  direction: P5Vector,
) -> Nil

@external(javascript, "../p5.mjs", "directional_light__color_x_y_z")
pub fn directional_light__color_x_y_z(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn directional_light__v1_v2_v3_direction(
  v1: Float,
  v2: Float,
  v3: Float,
  direction: P5Vector,
...
pub fn directional_light__v1_v2_v3_x_y_z(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn dist__x1_y1_z1_x2_y2_z2(
  x1: Float,
  y1: Float,
  z1: Float,
  x2: Float,
...
pub fn ellipsoid__radius_x_radius_y_radius_z(
  radius_x: Float,
  radius_y: Float,
  radius_z: Float,
) -> Nil
...
pub fn ellipsoid__radius_x_radius_y_radius_z_detail_x(
  radius_x: Float,
  radius_y: Float,
  radius_z: Float,
  detail_x: Int,
...
pub fn ellipsoid__radius_x_radius_y_radius_z_detail_x_detail_y(
  radius_x: Float,
  radius_y: Float,
  radius_z: Float,
  detail_x: Int,
...
pub fn emissive_material__v1_v2_v3_alpha(
  v1: Float,
  v2: Float,
  v3: Float,
  alpha: Float,
...
pub fn filter__filter_type_filter_param(
  filter_type: String,
  filter_param: Float,
) -> Nil

@external(javascript, "../p5.mjs", "filter__filter_type_filter_param_use_web_gl")
pub fn filter__filter_type_filter_param_use_web_gl(
  filter_type: String,
  filter_param: Float,
  use_web_gl: Bool,
) -> Nil
...
pub fn filter__filter_type_use_web_gl(
  filter_type: String,
  use_web_gl: Bool,
) -> Nil
...
pub fn frustum__left_right_bottom(
  left: Float,
  right: Float,
  bottom: Float,
) -> Nil
...
pub fn frustum__left_right_bottom_top(
  left: Float,
  right: Float,
  bottom: Float,
  top: Float,
...
pub fn frustum__left_right_bottom_top_near(
  left: Float,
  right: Float,
  bottom: Float,
  top: Float,
...
pub fn frustum__left_right_bottom_top_near_far(
  left: Float,
  right: Float,
  bottom: Float,
  top: Float,
...
pub fn light_falloff__constant_linear_quadratic(
  constant: Float,
  linear: Float,
  quadratic: Float,
) -> Nil
...
pub fn load_image__path_success_callback(
  path: String,
  success_callback: fn(P5Image) -> Nil,
) -> P5Image

@external(javascript, "../p5.mjs", "load_image__path_success_callback_failure_callback")
pub fn load_image__path_success_callback_failure_callback(
  path: String,
  success_callback: fn(P5Image) -> Nil,
  failure_callback: fn(Event) -> Nil,
) -> P5Image
...
pub fn load_shader__vert_filename_frag_filename(
  vert_filename: String,
  frag_filename: String,
) -> P5Shader

@external(javascript, "../p5.mjs", "load_shader__vert_filename_frag_filename_success_callback")
pub fn load_shader__vert_filename_frag_filename_success_callback(
  vert_filename: String,
  frag_filename: String,
  success_callback: fn() -> Nil,
) -> P5Shader

@external(javascript, "../p5.mjs", "load_shader__vert_filename_frag_filename_success_callback_failure_callback")
pub fn load_shader__vert_filename_frag_filename_success_callback_failure_callback(
  vert_filename: String,
  frag_filename: String,
  success_callback: fn() -> Nil,
  failure_callback: fn() -> Nil,
) -> P5Shader
...
pub fn map__value_start1_stop1_start2_stop2(
  value: Float,
  start1: Float,
  stop1: Float,
  start2: Float,
...
pub fn map__value_start1_stop1_start2_stop2_within_bounds(
  value: Float,
  start1: Float,
  stop1: Float,
  start2: Float,
...
pub fn orbit_control__sensitivity_x_sensitivity_y(
  sensitivity_x: Float,
  sensitivity_y: Float,
) -> Nil

@external(javascript, "../p5.mjs", "orbit_control__sensitivity_x_sensitivity_y_sensitivity_z")
pub fn orbit_control__sensitivity_x_sensitivity_y_sensitivity_z(
  sensitivity_x: Float,
  sensitivity_y: Float,
  sensitivity_z: Float,
) -> Nil
...
pub fn orbit_control__sensitivity_x_sensitivity_y_sensitivity_z_options(
  sensitivity_x: Float,
  sensitivity_y: Float,
  sensitivity_z: Float,
  options: any,
...
pub fn ortho__left_right_bottom_top(
  left: Float,
  right: Float,
  bottom: Float,
  top: Float,
...
pub fn ortho__left_right_bottom_top_near(
  left: Float,
  right: Float,
  bottom: Float,
  top: Float,
...
pub fn ortho__left_right_bottom_top_near_far(
  left: Float,
  right: Float,
  bottom: Float,
  top: Float,
...
pub fn perspective__fovy_aspect_near(
  fovy: Float,
  aspect: Float,
  near: Float,
) -> Nil
...
pub fn perspective__fovy_aspect_near_far(
  fovy: Float,
  aspect: Float,
  near: Float,
  far: Float,
...
pub fn plane__width_height_detail_x(
  width: Float,
  height: Float,
  detail_x: Int,
) -> Nil
...
pub fn plane__width_height_detail_x_detail_y(
  width: Float,
  height: Float,
  detail_x: Int,
  detail_y: Int,
...
pub fn point_light__color_x_y_z(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn point_light__v1_v2_v3_position(
  v1: Float,
  v2: Float,
  v3: Float,
  position: P5Vector,
...
pub fn point_light__v1_v2_v3_x_y_z(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn save_gif__filename_duration_options(
  filename: String,
  duration: Float,
  options: any,
) -> Nil
...
pub fn save_sound__sound_file_file_name(
  sound_file: P5SoundFile,
  file_name: String,
) -> Nil
...
pub fn save_strings__list_filename_extension(
  list: Array(String),
  filename: String,
  extension: String,
) -> Nil
...
pub fn save_strings__list_filename_extension_is_crlf(
  list: Array(String),
  filename: String,
  extension: String,
  is_crlf: Bool,
...
pub fn save_table__table_filename_options(
  table: P5Table,
  filename: String,
  options: String,
) -> Nil
...
pub fn select__selectors_container(
  selectors: String,
  container: P5Element,
) -> P5Element
...
pub fn select_all__selectors_container(
  selectors: String,
  container: P5Element,
) -> Array(P5Element)
...
pub fn specular_material__v1_v2_v3_alpha(
  v1: Float,
  v2: Float,
  v3: Float,
  alpha: Float,
...
pub fn sphere__radius_detail_x_detail_y(
  radius: Float,
  detail_x: Int,
  detail_y: Int,
) -> Nil
...
pub fn splice__list_value_position(
  list: Array(any),
  value: any,
  position: Int,
) -> Array(any)
...
pub fn spot_light__color_position_direction(
  color: String,
  position: P5Vector,
  direction: P5Vector,
) -> Nil
...
pub fn spot_light__color_position_direction_angle(
  color: String,
  position: P5Vector,
  direction: P5Vector,
  angle: Float,
...
pub fn spot_light__color_position_direction_angle_concentration(
  color: String,
  position: P5Vector,
  direction: P5Vector,
  angle: Float,
...
pub fn spot_light__color_position_rx_ry_rz(
  color: String,
  position: P5Vector,
  rx: Float,
  ry: Float,
...
pub fn spot_light__color_position_rx_ry_rz_angle(
  color: String,
  position: P5Vector,
  rx: Float,
  ry: Float,
...
pub fn spot_light__color_position_rx_ry_rz_angle_concentration(
  color: String,
  position: P5Vector,
  rx: Float,
  ry: Float,
...
pub fn spot_light__color_x_y_z_direction(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn spot_light__color_x_y_z_direction_angle(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn spot_light__color_x_y_z_direction_angle_concentration(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn spot_light__color_x_y_z_rx_ry_rz(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn spot_light__color_x_y_z_rx_ry_rz_angle(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn spot_light__color_x_y_z_rx_ry_rz_angle_concentration(
  color: String,
  x: Float,
  y: Float,
  z: Float,
...
pub fn spot_light__v1_v2_v3_position_direction(
  v1: Float,
  v2: Float,
  v3: Float,
  position: P5Vector,
...
pub fn spot_light__v1_v2_v3_position_direction_angle(
  v1: Float,
  v2: Float,
  v3: Float,
  position: P5Vector,
...
pub fn spot_light__v1_v2_v3_position_direction_angle_concentration(
  v1: Float,
  v2: Float,
  v3: Float,
  position: P5Vector,
...
pub fn spot_light__v1_v2_v3_position_rx_ry_rz(
  v1: Float,
  v2: Float,
  v3: Float,
  position: P5Vector,
...
pub fn spot_light__v1_v2_v3_position_rx_ry_rz_angle(
  v1: Float,
  v2: Float,
  v3: Float,
  position: P5Vector,
...
pub fn spot_light__v1_v2_v3_position_rx_ry_rz_angle_concentration(
  v1: Float,
  v2: Float,
  v3: Float,
  position: P5Vector,
...
pub fn spot_light__v1_v2_v3_x_y_z_direction(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn spot_light__v1_v2_v3_x_y_z_direction_angle(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn spot_light__v1_v2_v3_x_y_z_direction_angle_concentration(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn spot_light__v1_v2_v3_x_y_z_rx_ry_rz(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn spot_light__v1_v2_v3_x_y_z_rx_ry_rz_angle(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn spot_light__v1_v2_v3_x_y_z_rx_ry_rz_angle_concentration(
  v1: Float,
  v2: Float,
  v3: Float,
  x: Float,
...
pub fn subset__list_start_count(
  list: Array(any),
  start: Int,
  count: Int,
) -> Array(any)
...
pub fn text_align__horiz_align_vert_align(
  horiz_align: String,
  vert_align: String,
) -> Nil
...
pub fn torus__radius_tube_radius_detail_x(
  radius: Float,
  tube_radius: Float,
  detail_x: Int,
) -> Nil
...
pub fn torus__radius_tube_radius_detail_x_detail_y(
  radius: Float,
  tube_radius: Float,
  detail_x: Int,
  detail_y: Int,
