...
pub fn bezier_vertex1(x2:Float, y2:Float, z2:Float, x3:Float, y3:Float, z3:Float, x4:Float, y4:Float, z4:Float)


@external(javascript, "./output.mjs", "bezierVertex")
pub fn bezier_vertex2(x2:Float, y2:Float, x3:Float, y3:Float, x4:Float, y4:Float)


@external(javascript, "./output.mjs", "vertex")
pub fn vertex1(x:Float, y:Float, z:Float, u:Float, v:Float)
...
@external(javascript, "./output.mjs", "vertex")
pub fn vertex3(x:Float, y:Float)
...
pub fn normal1(x:Float, y:Float, z:Float)


@external(javascript, "./output.mjs", "normal")
pub fn normal2(vector:Vector)
...
pub fn curve_vertex1(x:Float, y:Float, z:Float)


@external(javascript, "./output.mjs", "curveVertex")
pub fn curve_vertex2(x:Float, y:Float)
...
pub fn quadratic_vertex1(cx:Float, cy:Float, cz:Float, x3:Float, y3:Float, z3:Float)


@external(javascript, "./output.mjs", "quadraticVertex")
pub fn quadratic_vertex2(cx:Float, cy:Float, x3:Float, y3:Float)
