...
pub fn random1(choices:Array(a)) -> a


@external(javascript, "./p5.mjs", "random")
pub fn random2(min:Float, max:Float) -> Float
...
@external(javascript, "./p5.mjs", "vertex")
pub fn vertex3(x:Float, y:Float, z:Float, u:Float, v:Float) -> Nil


@external(javascript, "./p5.mjs", "rect")
pub fn rect1(x:Float, y:Float, w:Float, h:Float, detail_x:Int, detail_y:Int) -> Nil


@external(javascript, "./p5.mjs", "rect")
pub fn rect2(x:Float, y:Float, w:Float, h:Float, tl:Float, tr:Float, br:Float, bl:Float) -> Nil
...
pub fn end_shape(mode:String, count:Int) -> Nil
...
pub fn quad1(x1:Float, y1:Float, x2:Float, y2:Float, x3:Float, y3:Float, x4:Float, y4:Float, detail_x:Int, detail_y:Int) -> Nil


@external(javascript, "./p5.mjs", "quad")
pub fn quad2(x1:Float, y1:Float, z1:Float, x2:Float, y2:Float, z2:Float, x3:Float, y3:Float, z3:Float, x4:Float, y4:Float, z4:Float, detail_x:Int, detail_y:Int) -> Nil
...
@external(javascript, "./p5.mjs", "scale")
pub fn scale2(s:Float, y:Float, z:Float) -> Nil
...
@external(javascript, "./p5.mjs", "translate")
pub fn translate2(x:Float, y:Float, z:Float) -> Nil
...
@external(javascript, "./p5.mjs", "point")
pub fn point2(x:Float, y:Float, z:Float) -> Nil
...
pub fn arc(x:Float, y:Float, w:Float, h:Float, start:Float, stop:Float, mode:String, detail:Int) -> Nil
...
pub fn begin_shape(kind:String) -> Nil
...
pub fn rotate(angle:Float, axis:Vector) -> Nil
...
pub fn square(x:Float, y:Float, s:Float, tl:Float, tr:Float, br:Float, bl:Float) -> Nil
...
pub fn ellipse1(x:Float, y:Float, w:Float, h:Float) -> Nil


@external(javascript, "./p5.mjs", "ellipse")
pub fn ellipse2(x:Float, y:Float, w:Float, h:Float, detail:Int) -> Nil


@external(javascript, "./p5.mjs", "randomGaussian")
pub fn random_gaussian(mean:Float, sd:Float) -> Float
